            ...
            {groupedStories.map(group => (
              <div key={group.year} className="relative mb-6 last:mb-0">
                <button
                  ...
                  className={`text-2xl font-bold font-serif transition-colors duration-300 block text-left ${
                      ...
                      >
                         ...
                         <div className="flex-1 min-w-0 py-1">
                            <div className="flex justify-between items-start gap-4">
                              ...
                              <ArrowRight size={18} className="text-slate-300 -translate-x-2 opacity-0 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300 text-teal-500 dark:text-teal-400 shrink-0" />
                            </div>
